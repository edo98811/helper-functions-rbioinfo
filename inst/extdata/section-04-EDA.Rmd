...
for (col in factor_columns) {
  cat(paste0("Unique values for ", col, ": ", paste0(unique(colData(dds)[[col]]), collapse = ", ")))
}
cat("are all necessary columns factors?")
...
cat(paste0("numer of genes: ", nrow(dds))) # total number of genes
```
