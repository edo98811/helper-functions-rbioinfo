...
# expressed_ensembl_gene_id <- anns[anns$uniprotswissprot %in% expressed_uniprot_id, "ensembl_gene_id"]
expressed_gene_symbol <- anns[anns$uniprotswissprot %in% expressed_uniprot_id, "mgi_symbol"]
